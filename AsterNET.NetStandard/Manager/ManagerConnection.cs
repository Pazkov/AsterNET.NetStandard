...
namespace AsterNET.NetStandard.Manager
{
    ...
    public class ManagerConnection
    {
        ...
        private int defaultResponseTimeout = 5000;
        ...
        /// <summary>
		/// An AgentRingNoAnswer is triggered when an agent is ring out.<br/>
        ...
        public ManagerConnection()
        {
            ...
            Helper.RegisterEventHandler(registeredEventHandlers, 98, typeof(AgentRingNoAnswerEvent));
        ...
        private void login(int timeout)
        {
            ...
            if (response is ChallengeResponse)
            {
                ...
                Action.LoginAction loginAction = new Action.LoginAction(username, "MD5", key, "on");
        ...
        private void fireEvent(ManagerEvent e)
        {
            if (enableEvents && internalEvent != null)
                if (UseASyncEvents)
                {
                    var workTask = Task.Run(() => internalEvent.Invoke(this, e));
